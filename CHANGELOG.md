...
## 2026-01-30
- Group health report issues by source page in the report UI (collapsible).
- Move issue status to page-level group controls in reports.
- Export CSV reports sorted by source page for easier grouping.
